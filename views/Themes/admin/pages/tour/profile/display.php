	    ...
	    <div class="profile-left-content" style="padding-top: 0">
			                ...
			                <td class="data">
			                	...
			                	<?php
						            ...
						            echo '<div class="group-btn">';
							            ...
							            // echo '<button class="btn btn-small" style=""></button>';
							            echo '<button data-plugin="dropdown2" class="btn btn-small" style="background-color:'.$this->item['status_background'].';color:#fff" data-options="'.Fn::stringify( array( 'select' => $dropdownList, 'axisX'=> 'right', 'container'=> '.profile-left-main', ) ).'"><span class="fwn">'.$this->item['status_name'].'</span><i class="icon-angle-down mls"></i></button>';
						            echo '</div>';
						        ?>
		    ...
		    <div class="profile-left-footer gb-btn-block">
		        ...
		        <?php
		            ...
		            $dropdownList[] = array(
		                'text' => 'ดูตัวอย่าง',
		                'href' =>  DOCS.'tour/pdf/'.$this->item['id'],
		        ...
		        ?>
		        <span class="btn-group">
		            <a type="button" class="btn" target="_blank" href="<?=DOWNLOAD?>document/pdf/<?=$this->item['id']?>"><i class="icon-file-pdf-o mrs"></i><span>ดาวน์โหลด PDF</span></a>
