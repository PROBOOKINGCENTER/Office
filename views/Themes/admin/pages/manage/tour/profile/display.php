<section id="profile" class="section clearfix" data-plugin="main2" data-options="<?=Fn::stringify( $this->opt )?>">
	<!-- has-leftCol  -->
		...
		<header class="section-header" role="header">
			<div class="inner">
				...
				<div class="toolbar clearfix">
					<h1 class="title lfloat"><?= !empty($this->listOpt['icon'])? '<i class="icon-'.$this->listOpt['icon'].' mrs"></i>': '';?><span><?=$this->opt['title']?></span></h1>
					<?php 
