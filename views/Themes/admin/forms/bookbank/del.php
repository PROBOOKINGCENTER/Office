...
if( !empty($this->item['permit']['del']) ){
	...
	$arr['form'] = '<form class="js-submit-form" action="'.URL.'settings/bookbank/del'.$next.'"></form>';
	$arr['hiddenInput'][] = array('name'=>'id','value'=>$this->item['id']);
	$arr['body'] = "คุณต้องการจะลบ <span class=\"fwb\">\"{$this->item['code']}: {$this->item['name']}\"</span> หรือไม่?";
