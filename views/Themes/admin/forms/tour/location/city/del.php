...
if( !empty($this->item['permit']['del']) ){
	...
	$arr['form'] = '<form class="js-submit-form" action="'.URL.'tour/location/city/del'.$next.'"></form>';
	$arr['hiddenInput'][] = array('name'=>'id','value'=>$this->item['id']);
	$arr['body'] = "Are you sure you want to delete <span class=\"fwb\">\"{$this->item['name']}\"</span>?";
	...
	$arr['body'] = "You can't delete <span class=\"fwb\">\"{$this->item['name']}\"</span>";
