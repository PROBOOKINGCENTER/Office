...
class th extends Langs {
	...
	public function basics($text=null) {
		...
		$data['serie management'] = 'จัดการทัวร์';
		$data['series tour'] = 'ซีรี่ย์ ทัวร์';
		$data['search'] = 'ค้นหา';
		$data['country'] = 'ประเทศ';
		$data['city'] = 'เมือง';
		$data['download'] = 'ดาวน์โหลด';
		$data['status'] = 'สถานะ';
		$data['airline'] = 'สายการบิน';
		$data['all'] = 'ทั้งหมด';
		$data['enable'] = 'เปิดการใช้งาน';
		$data['disable'] = 'ระงับการใช้งาน';
